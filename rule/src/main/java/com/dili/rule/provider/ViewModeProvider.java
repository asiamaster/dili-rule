...
@Component
@Scope("prototype")
public class ViewModeProvider implements ValueProvider {

    private static final List<ValuePair<?>> BUFFER;

    static {
        BUFFER = Lists.newArrayList();
        BUFFER.addAll(Stream.of(ViewModeEnum.values())
    ...
    public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
        ...
        ViewModeEnum instance = ViewModeEnum.getInstance(Integer.valueOf(obj.toString()));
