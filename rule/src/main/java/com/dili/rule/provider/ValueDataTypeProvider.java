...
@Component
@Scope("prototype")
public class ValueDataTypeProvider implements ValueProvider {

    private static final List<ValuePair<?>> BUFFER;

    static {
        BUFFER = Lists.newArrayList();
        BUFFER.addAll(Stream.of(ValueDataTypeEnum.values())
    ...
    public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
        ...
        ValueDataTypeEnum instance = ValueDataTypeEnum.getInstance(Integer.valueOf(obj.toString()));
