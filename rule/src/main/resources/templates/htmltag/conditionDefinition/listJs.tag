<script>
    ...
    /*********************变量定义区 begin*************/
        //行索引计数器
        //如 let itemIndex = 0;
    let _dataGrid = $('#conditionDefinitionGrid');
    ...
    function openUpdateHandler() {
        ...
        let url = "/conditionDefinition/preSave.html?id=" + selectedRow.id;
        dia = bs4pop.dialog({
            title: '修改预定义条件',
            content: url,
            isIframe: true,
    ...
    function doDeleteHandler() {
        ...
        bs4pop.confirm(msg, undefined, function (sure) {
            if(sure){
                ...
                $.ajax({
                    type: "POST",
                    url: "${contextPath}/conditionDefinition/doDelete.action",
    ...
    function queryParams(params) {
        ...
        return $.extend(temp, bui.util.bindGridMeta2Form('conditionDefinitionGrid', 'conditionDefinitionQueryForm'));
    }
